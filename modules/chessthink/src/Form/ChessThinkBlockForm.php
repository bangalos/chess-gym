...
/**
 * @file
 * Contains \Drupal\chessthink\Form\BlockFormController
 */
...
/**
 * Chess Think block form
 */
class ChessThinkBlockForm extends FormBase {
  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'chessthink_block_form';
  }
  /**
   * {@inheritdoc}
   * Chess think generator block.
   */
